            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
                <div className="grid grid-cols-2 md:grid-cols-12 gap-6">
                    ...
                    <div className="col-span-2 md:col-span-4">
                        ...
                        <div className="flex items-center gap-3">
                            <a
                                href="https://github.com/I-Vishal-Kumar/Prompty-pics"
                    ...
                    <div className="col-span-2 md:col-span-4">
                        ...
                        <form className="flex flex-col sm:flex-row gap-2 sm:gap-0">
                            ...
                            <button
                                type="submit"
                                className="w-full sm:w-auto px-6 py-2.5 text-sm font-medium text-white bg-emerald-500 rounded-lg sm:rounded-l-none hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors whitespace-nowrap"
                            >
                                Subscribe
                            </button>
                        </form>
                ...
                <div className="mt-8 pt-4 text-center border-t border-gray-100">
                    <p className="text-sm text-gray-600">
                        © {currentYear} PromptyPics. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
