        ...
        const fetchGeneration = async () => {
            try {
                ...
                if (response.data.success) {
                    ...
                    toast.error(
                        response.data.message || "Failed to load generation"
                    );
                ...
                toast.error(
                    error.response?.data?.message || "Failed to load generation"
                );
                navigate.push("/dashboard");
            } finally {
                setLoading(false);
